...
DEPARTMENT_TO_CANONICAL = {
    ...
    # --- BABY CARE ---
    r"BABY": "Product Inquiry - Baby Care", # Catch-all for AVEENO BABY, JOHNSON BABY
    ...
    r"MAXI": "Product Inquiry - Women's Health",
    r"ALWAYS ULTRA": "Product Inquiry - Women's Health",
    ...
    # --- MISSING CATEGORIES (Added these for complete coverage) ---
    ...
    # Specific Natural Oils & Sprays
    r"CASTOR OIL": "Product Inquiry - Homeopathy",
    r"NEEM": "Product Inquiry - Homeopathy",
    r"RESCUE REMEDY": "Product Inquiry - Homeopathy", # Very common brand
    r"BACH FLOWER": "Product Inquiry - Homeopathy",
}

CATEGORY_TO_CANONICAL = {
    r"CONDOM": "Product Inquiry - Men Care|Product Inquiry - Women's Health",
    r"FOR HIM": "Product Inquiry - Men Care",
    r"SHAVING": "Product Inquiry - Men Care",
    r"GILLETTE": "Product Inquiry - Men Care",
    ...
    r"INTIMATE WASH": "Product Inquiry - Women's Health",
    r"FEMININE": "Product Inquiry - Women's Health",
    r"TAMPON": "Product Inquiry - Women's Health",

    r"PERFUME": "Product Inquiry - Perfumes",
}

# 2. SUB-CATEGORY RULES (Refined Priority)
SUB_CAT_RULES = {

    # --- HAIR FORMS ---
    # Moved Styling UP so 'Styling Cream' is caught before 'Cream' (Moisturizer)
    'Styling': ['gel', 'mousse', 'spray', 'wax', 'pomade', 'edge control', 'curl', 'brylcreem', 'styling'],
    'Shampoo': ['shampoo', 'wash', 'cleanser'],
    'Conditioner': ['conditioner', 'leave-in', 'rinse-out', 'detangler'],
    ...
    # Generic 'Cream' is at the bottom so specific creams (Eye/Styling) get caught first
    ...
    'Cold & Flu': ['cold', 'flu', 'cough', 'sinus', 'throat', 'lozenge'],
